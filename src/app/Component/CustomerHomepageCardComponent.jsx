  ...
  return (
    <div className="group relative w-full h-[700px] bg-gradient-to-br from-amber-50 to-white rounded-[2.5rem] p-8 flex flex-col justify-between overflow-hidden border border-amber-100 shadow-[0_20px_50px_rgba(245,158,11,0.05)] transition-all duration-500 hover:shadow-[0_40px_80px_rgba(245,158,11,0.1)] hover:-translate-y-2">
      ...
      <div className="relative z-10 flex items-center justify-center py-4 transition-transform duration-700 group-hover:scale-110">
        <img
          src="https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?q=80&w=3456&auto=format&fit=crop"
          alt="customer illustration"
          className="w-full h-[300px] object-cover rounded-xl drop-shadow-[0_35px_35px_rgba(245,158,11,0.3)] object-top"
        />
      </div>
      <div className="relative z-10 w-full flex items-center justify-between border-t border-amber-100/50 pt-6">
        ...
        <Link href="/customers">
          <Button className="group/btn bg-amber-400 hover:bg-amber-500 text-white h-14 px-8 rounded-2xl font-bold shadow-lg shadow-amber-200 transition-all flex gap-2">
            View All
